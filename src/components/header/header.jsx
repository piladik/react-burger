            ...
            <nav className={navStyles.nav}>
                <div className={navStyles.nav_box}>
                    <div className={`${navStyles.nav_item} ${navStyles.nav_item_active}`}>
                        <BurgerIcon />
                        <a className={`${navStyles.nav_link} ${navStyles.active}`} href="/">Конструктор</a>
                    </div>
                    <div className={navStyles.nav_item}>
                        <ListIcon type="primary" />
                        <a className={navStyles.nav_link} href="/">Лента заказов</a>
                    </div>     
                </div>
                ...
                <div className={navStyles.nav_box}>
                    <div className={navStyles.nav_item}>
                        ...
                        <a className={navStyles.nav_link} href="/">Личный кабинет</a>
                    </div>
                </div>
            </nav>
        </header>
